...
%Nx = hdrinf.data(2); number of A-lines (ADD SPARE LINES?)
Nx = 100;
Nt = hdrinf.data(1); %samples per A-line
max_file_number = 7;
number_of_images = (max_file_number+1)*2; %this could be got rid of by just starting fnum at 1
...
for fnum = 0:max_file_number
    ...
    data = data'; %SHOULD THIS BE DONE TWICE??
